...
def dbmanager_by_user(db_manager):
    """
    Функция для взаимодействия с пользователем и вывода информации о вакансиях.
    :param db_manager: объект класса DBManager для работы с базой данных
    """
    ...
    while True:
        ...
        if user_input == '1':
            ...
            db_manager.get_companies_and_vacancies_count()  # получает список всех компаний и количество вакансий у
            # каждой компании
            print("Запрос осуществлен, для возврата в меню нажмите '0'")
        elif user_input == '3':
            db_manager.get_all_vacancies()  # получает список всех вакансий с указанием названия компании, названия
            ...
            db_manager.get_vacancies_with_higher_salary()  # получает список всех вакансий, у которых зарплата выше
            # средней по всем вакансиям.
            print("Запрос осуществлен, для возврата в меню нажмите '0'")
        elif user_input == '6':
            user_input = input()
            db_manager.get_vacancies_with_keyword(
                user_input)  # получает список всех вакансий, в названии которых содержатся переданные в метод слова
            print("Запрос осуществлен, для возврата в меню нажмите '0'")
        elif user_input == '0':
            print(job_options)
        else:
